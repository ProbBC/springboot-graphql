...
public class ProdutoGraphQL implements GraphQLQueryResolver, GraphQLMutationResolver {
    ...
    public Produto produto(Long id) { return service.findById(id); }

    public List<Produto> getProdutos() { return service.findAll(); }
    ...
    public Boolean deleteProduto(Long id) { return service.deleteById(id); }
}
